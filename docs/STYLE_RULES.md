...
- Avoid conversational phrasing that depends on speaker/listener context.

Rules:
- Do not use first-person or second-person wording in comments or docs (avoid words such as `I`, `me`, `my`, `we`, `our`, `you`, `your`).
- Avoid wording that implies generated authorship or external conversational context.
- Prefer neutral imperative or descriptive wording.
  - Good: "Set `WS_DIR` for a non-default workspace."
  - Avoid: "If a non-default workspace is used, set `WS_DIR`."
