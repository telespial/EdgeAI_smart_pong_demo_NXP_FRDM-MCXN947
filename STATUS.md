...
- Binary: mcuxsdk_ws/build_smart_pong_accel_debug_v1/edgeai_smart_pong_demo_cm33_core0.bin
- Flash: west flash -d mcuxsdk_ws/build_smart_pong_accel_debug_v1 -r linkserver
