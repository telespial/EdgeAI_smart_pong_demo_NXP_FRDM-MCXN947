...
if [[ ! -d "$OVERLAY_DIR/demo_apps/edgeai_smart_pong_demo" ]]; then
...
cp -a "$OVERLAY_DIR/demo_apps/edgeai_smart_pong_demo" "$MCUX_EXAMPLES_DIR/demo_apps/"
cp -a "$OVERLAY_DIR/_boards/frdmmcxn947/demo_apps/edgeai_smart_pong_demo" "$MCUX_EXAMPLES_DIR/_boards/frdmmcxn947/demo_apps/"

echo "Installed edgeai_smart_pong_demo wrapper into: $MCUX_EXAMPLES_DIR"
